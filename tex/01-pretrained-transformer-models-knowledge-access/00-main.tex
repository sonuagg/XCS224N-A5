...
We provide a script \texttt{src/collect\_submission.sh} to collect these files and create a zip file for submission. You can run the script on Linux/Mac systems or use the \texttt{collect\_submission.bat} on Windows, then submit the zip file to the assignment.
